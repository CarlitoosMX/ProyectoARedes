  ...
  prediction(){
    const predictionData = {
      ...
      "messages": [
        ...
        {"role": "user", "content": "Los equipos de la Liga Mexicana MX siguientes van a jugar un partido, y estas son algunas estadísticas pasadas de sus partidos anteriores: FC América: Últimos partidos jugados: 2-0, ganador, 2-1, ganador, 3-0, perdedor; León: Últimos partidos jugados: 3-1, perdedor, 1-0, ganador, 0-0, empate. Analiza el rendimiento de ambos equipos y determina quién tiene más posibilidades de salir victorioso del encuentro."}
      ]
    };
